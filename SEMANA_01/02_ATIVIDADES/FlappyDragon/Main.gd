...
var status = 1 #1 == jogando
var vscore = 0 #pontuação
var x = 2 #posição horizontal (alterei de 1.5 para 2 para aumentara velocidade)
var y = 2 #posição vertical (alterei de 1.5 para 2 para aumentara velocidade)
